...
<head>
    ...
    <link rel="icon" href="#">
    <title>Products || Online Food Ordering System - Code Camp BD</title>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12  col-md-4 col-lg-4 profile-img">
                            <div class="image-wrap">
                                <figure><?php echo '<img src="admin/Res_img/'.$rows['image'].'" alt="Gizmos Gadget Shop">'; ?></figure>
                            </div>
                        </div>
                        <!--  Author Name: MH RONY.
                        GigHub Link: https://github.com/dev-mhrony
                            ...
                            <div class="food-item">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-lg-3 pull-right item-cart-info">
                                        ...
                                        <input class="b-r-0" type="text" name="quantity" style="margin-left:30px;" value="1" size="1" />
                                        <input type="submit" class="btn theme-btn" style="margin-top:20px;" value="Add To Cart" />
                                    </div>
                                    </form>
                                </div>
